...
function GetByIdComp (){
    const [computers, setDisplay] = useState<IComputer[]>([]);
    ...
    const Get = async() : Promise<Array<any>>   => {
        ...
        const res: Response =  await fetch(`http://localhost:7169/Computer/${num}`);
